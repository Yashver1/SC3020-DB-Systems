...
struct Record {
  ...
  Record()
    ...
    Record(unsigned offset, std::string gameDateEst, std::string teamIdHome, std::string ptsHome, 
       std::string fgPctHome, std::string ftPctHome, std::string fg3PctHome,
       std::string astHome, std::string rebHome, std::string homeTeamWins) : Header(RecordHeader{offset}) {
          try {
  ...
  Record(unsigned offset, std::array<Byte,3> gameDateEst, unsigned teamIdHome, Byte ptsHome, 
       float fgPctHome, float ftPctHome, float fg3PctHome,
       Byte astHome, Byte rebHome, Byte homeTeamWins) : Header(RecordHeader{offset}), 
